<?php /* Smarty version Smarty-3.1.19, created on 2016-10-28 10:55:02
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:63787728358131266cff947-05002342%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b460c3e43d2853125ce1c333ebb40a1ceca82a3b' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/authentication.tpl',
      1 => 1475245091,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '63787728358131266cff947-05002342',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58131267582681_13424712',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58131267582681_13424712')) {function content_58131267582681_13424712($_smarty_tpl) {?>
...
<?php }?></h1>
<?php if (isset($_smarty_tpl->tpl_vars['back']->value)&&preg_match("/^http/",$_smarty_tpl->tpl_vars['back']->value)) {?><?php $_smarty_tpl->tpl_vars['current_step'] = new Smarty_variable('login', null, 0);?>
	<div class="container">
		<div class="row">
...
" /><?php }?>
							<button class="btn-blf white" type="submit" id="SubmitCreate" name="SubmitCreate">
								<span>
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
						...
						<p class="submit">
							<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
							<button type="submit" id="SubmitLogin" name="SubmitLogin" class="btn-blf white">
								<span>
...
" />
			...
			<p class="cart_navigation required submit clearfix">
				...
				<button type="submit" class="btn-blf white" name="submitGuestAccount" id="submitGuestAccount">
					<span>
...
<?php }?>" />
 ...
 <sup>*</sup></label>
						...
						<div class="required password confirm form-group">
							<label for="passwd_confirm"><?php echo smartyTranslate(array('s'=>'Confirm Password'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<input type="password" class="is_required validate form-control" name="passwd_confirm" id="passwd" />
...
<?php }?>" />
					...
					<div class="submit clearfix">
						...
						<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
						<button type="submit" name="submitAccount" id="submitAccount" class="btn-blf white">
