<?php /* Smarty version Smarty-3.1.19, created on 2016-11-02 17:21:44
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/modules/blocknewsletter/blocknewsletter.tpl" */ ?>
<?php /*%%SmartyHeaderCode:86215527581a1298d836c2-23627308%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '649389851cd15da3f049a8307c173b175cec9c6d' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/modules/blocknewsletter/blocknewsletter.tpl',
      1 => 1475245116,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '86215527581a1298d836c2-23627308',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_581a1298dc1490_76320308',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_581a1298dc1490_76320308')) {function content_581a1298dc1490_76320308($_smarty_tpl) {?>
...
<div id="newsletter_block_left" class="col-sm-6">
	...
	<div class="block_content container">
		<div class="row">
			<div class="col-sm-6"><?php echo smartyTranslate(array('s'=>'Subscribe to our newsletter and receive all the news from Bougie la Française','mod'=>'blocknewsletter'),$_smarty_tpl);?>
</div>
...
" method="post">
				<div class="col-sm-6 form-group<?php if (isset($_smarty_tpl->tpl_vars['msg']->value)&&$_smarty_tpl->tpl_vars['msg']->value) {?> <?php if ($_smarty_tpl->tpl_vars['nw_error']->value) {?>form-error<?php } else { ?>form-ok<?php }?><?php }?>" >
					<input class="inputNew form-control grey newsletter-input" id="newsletter-input" type="email" name="email" size="18" value="<?php if (isset($_smarty_tpl->tpl_vars['msg']->value)&&$_smarty_tpl->tpl_vars['msg']->value) {?><?php echo $_smarty_tpl->tpl_vars['msg']->value;?>
...
<?php }?>" />
					<button type="submit" class="btn btn-blf-send">
						<i class="ycon-newletter"></i>
					</button>
