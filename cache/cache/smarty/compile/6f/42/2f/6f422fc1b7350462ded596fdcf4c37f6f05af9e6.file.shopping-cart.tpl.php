<?php /* Smarty version Smarty-3.1.19, created on 2016-10-28 10:54:37
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11308611875813124d7325c9-87021449%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6f422fc1b7350462ded596fdcf4c37f6f05af9e6' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/shopping-cart.tpl',
      1 => 1476100036,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11308611875813124d7325c9-87021449',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5813124db38c42_77134631',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5813124db38c42_77134631')) {function content_5813124db38c42_77134631($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/modifier.regex_replace.php';
?>

<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'My shopping cart'),$_smarty_tpl);?>
...
<h1 id="cart_title" class="page-heading">
	<?php echo smartyTranslate(array('s'=>'My shopping cart'),$_smarty_tpl);?>
...
<?php }?>" class="btn-blf-cart-next" title="<?php echo smartyTranslate(array('s'=>'Proceed to checkout'),$_smarty_tpl);?>
">
...
<?php }?>" class="btn-blf-cart-back" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
">
			<i class="ycon-left-open-big"></i><span><?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
</span>
		</a>
	</p>
...
<?php }?>" />
										...
										<button type="submit" name="submitAddDiscount" class="btn-blf btn-blf-small">
...
<?php }?>" />
				<input type="hidden" name="submitDiscount" />
				<button type="submit" name="submitAddDiscount" class="btn-blf-black-ok"><span><?php echo smartyTranslate(array('s'=>'OK'),$_smarty_tpl);?>
</span></button>
			</fieldset>
		</form>
		<?php if ($_smarty_tpl->tpl_vars['displayVouchers']->value) {?>
