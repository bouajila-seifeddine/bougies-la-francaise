<?php /* Smarty version Smarty-3.1.19, created on 2016-10-25 11:49:00
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1220139454580f2a8c542421-86852264%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70e3c6880a86b3df2bb21207fe02c48facbac4df' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/history.tpl',
      1 => 1475245092,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1220139454580f2a8c542421-86852264',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_580f2a8c5decd5_46500290',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580f2a8c5decd5_46500290')) {function content_580f2a8c5decd5_46500290($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
" target="_blank">
							...
							<td class="history_detail">
								<a class="btn-blf btn-blf-smaller" href="javascript:showOrder(1, <?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
, '<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
...
<ul class="footer_links clearfix">
	<li>
		<a class="btn-blf back" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('my-account',true), ENT_QUOTES, 'UTF-8', true);?>
">
			<span>
				<i class="ycon-left-open-big"></i> <?php echo smartyTranslate(array('s'=>'Back to Your Account'),$_smarty_tpl);?>

			</span>
		</a>
	</li>
	<li>
		<a class="btn-blf back" href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
">
			<span><i class="ycon-left-open-big"></i> <?php echo smartyTranslate(array('s'=>'Home'),$_smarty_tpl);?>
</span>
		</a>
	</li>
</ul>
