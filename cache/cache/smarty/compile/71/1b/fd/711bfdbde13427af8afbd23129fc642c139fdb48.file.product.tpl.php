<?php /* Smarty version Smarty-3.1.19, created on 2016-11-02 14:36:39
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15648306215819ebe74cb597-02794590%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '711bfdbde13427af8afbd23129fc642c139fdb48' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/product.tpl',
      1 => 1477391113,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15648306215819ebe74cb597-02794590',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5819ebe7a455f3_36953211',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5819ebe7a455f3_36953211')) {function content_5819ebe7a455f3_36953211($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/function.counter.php';
?>
...
" />
		...
		<?php }?>
		<!-- left infos-->
		<div class="pb-left-column product-picture-side col-xs-12 col-sm-5 col-md-6">
			<!-- product img-->
...
"<?php }?> itemprop="image" />
					...
					<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>2) {?>
						<div class="view_scroll_spacer">						
							<a id="view_scroll_right" class="view_scroll_spacer" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
" href="javascript:{}">
...
" data-id="resetImages">
		...
		<div class="product-infos-side col-md-6 col-sm-6 col-xs-12">
			
			<!-- center infos -->
			<div class="pb-center-column">
				<?php if ($_smarty_tpl->tpl_vars['product']->value->online_only) {?><p class="online_only"><?php echo smartyTranslate(array('s'=>'Online only'),$_smarty_tpl);?>
</p><?php }?>
				<p class="product-collection"><?php if (isset($_smarty_tpl->tpl_vars['features']->value['feature7'])) {?><?php echo $_smarty_tpl->tpl_vars['features']->value['feature7']['value'];?>
<?php }?></p>
				<h1 class="product-name" itemprop="name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</h1>
				...
				<?php if ($_smarty_tpl->tpl_vars['product']->value->description_short||count($_smarty_tpl->tpl_vars['packItems']->value)>0) {?>
					<div id="short_description_block">
						...
						<?php if ($_smarty_tpl->tpl_vars['product']->value->description) {?>
							<a href="#full-description-product" class="more-detail"><?php echo smartyTranslate(array('s'=>'More details'),$_smarty_tpl);?>
 &gt;</a>
							<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->universe)) {?>
							<br /><a href="#full-universe-product" class="more-detail"><?php echo smartyTranslate(array('s'=>'Universe information'),$_smarty_tpl);?>
 &gt;</a>
							<?php }?>
						...
						<!--<?php if (count($_smarty_tpl->tpl_vars['packItems']->value)>0) {?>
							...
							<p><?php echo smartyTranslate(array('s'=>'Pack content'),$_smarty_tpl);?>
</p>
...
" id="product_page_product_id" />
					...
					<div class="product-price-block container">
						<div class="row">
							<div class="col-xs-6">
...
<?php }?></span>
				...
				<div class="more-product-infos">
					<div class="infos-delivery-shipping">
						<p><span><?php echo smartyTranslate(array('s'=>'Delivery delay'),$_smarty_tpl);?>
 : </span><?php echo smartyTranslate(array('s'=>'2 or 3 days'),$_smarty_tpl);?>
</p>
						<p><span><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
 : </span><?php echo smartyTranslate(array('s'=>'Free shipping with 50€ minimum purchase'),$_smarty_tpl);?>
</p>
						<p><span><?php echo smartyTranslate(array('s'=>'Product code'),$_smarty_tpl);?>
 : </span><?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
</p>
...
<?php }?></span>
				...
				<div class="product-social-block clearfix">
					<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'customSocialProduct'),$_smarty_tpl);?>
...
<?php if ((isset($_smarty_tpl->tpl_vars['quantity_discounts']->value)&&count($_smarty_tpl->tpl_vars['quantity_discounts']->value)>0)) {?>
			...
			<section class="page-product-box">
				<p class="page-product-heading"><?php echo smartyTranslate(array('s'=>'Volume discounts'),$_smarty_tpl);?>
</p>
...
<div class="full-container">
	<div id="full-description-product">
		<div class="container">
			<div class="row">
				<div class="center_column col-xs-12">
					<div class="row">	
						<?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description) {?>
							<!-- More info -->
							<section class="page-product-box col-sm-6 col-xs-12">
								<p class="page-product-heading"><?php echo smartyTranslate(array('s'=>'More info'),$_smarty_tpl);?>
</p>
								<!-- full description -->
						...
						<?php if (isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value) {?>
							<!-- Data sheet -->
							<section class="page-product-box col-sm-6 col-xs-12">
								<p class="page-product-heading"><?php echo smartyTranslate(array('s'=>'Data sheet'),$_smarty_tpl);?>
</p>
...
">
	...
	<?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&!empty($_smarty_tpl->tpl_vars['product']->value->universe)) {?>
	<div id="full-universe-product">
		<div class="container">
			<div class="row">
				<div class="center_column col-xs-12">
					<div class="row">	
						<!-- More info -->
						<section class="page-product-box col-xs-12">
							<p class="page-product-heading"><?php echo smartyTranslate(array('s'=>'Universe'),$_smarty_tpl);?>
</p>
							<!-- full universe -->
							<div class="rte"><?php echo $_smarty_tpl->tpl_vars['product']->value->universe;?>
</div>
							<div class="universe-link"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getCMSLink(75);?>
"><?php echo smartyTranslate(array('s'=>"See all universes"),$_smarty_tpl);?>
</a></div>
						</section>
						<!--end  More info -->
					</div>
...
<div class="row">
	<div class="center_column col-xs-12 col-sm-12">
		...
		<section id="blockpack">
			<p class="page-product-heading"><?php echo smartyTranslate(array('s'=>'Pack content'),$_smarty_tpl);?>
</p>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value) {?>
			<!--Accessories -->
			<section class="page-product-box">
				<p class="secondary-title"><span><?php echo smartyTranslate(array('s'=>'Accessories'),$_smarty_tpl);?>
</span></p>
...
?>
								<?php  $_smarty_tpl->tpl_vars['feature'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['feature']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['accessory']->value['features']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['feature']->key => $_smarty_tpl->tpl_vars['feature']->value) {
$_smarty_tpl->tpl_vars['feature']->_loop = true;
?>
						            <?php if ($_smarty_tpl->tpl_vars['feature']->value['name']=="Collection") {?>
						                <?php $_smarty_tpl->tpl_vars['collection'] = new Smarty_variable($_smarty_tpl->tpl_vars['feature']->value['value'], null, 0);?>
						            <?php }?>
						        <?php } ?>
...
" class="product_description">
										...
										<div class="s_title_block">
											<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessoryLink']->value, ENT_QUOTES, 'UTF-8', true);?>
">
												<div class="accessory-collection"><?php if (isset($_smarty_tpl->tpl_vars['collection']->value)) {?><span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['collection']->value, ENT_QUOTES, 'UTF-8', true);?>
</span><?php }?></div>
												<p itemprop="name" class="product-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</p>
...
<?php }?>
		...
		<?php if ((isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->description)||(isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value)||(isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value)||(isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB']->value)||(isset($_smarty_tpl->tpl_vars['attachments']->value)&&$_smarty_tpl->tpl_vars['attachments']->value)||isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->customizable) {?>
			...
			<!--Download -->
			<section class="page-product-box">
				<p class="page-product-heading"><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</p>
...
">
 ...
 (<?php echo Tools::formatBytes($_smarty_tpl->tpl_vars['attachment']->value['file_size'],2);?>
			...
			<!--Customization -->
			<section class="page-product-box">
				<p class="page-product-heading"><?php echo smartyTranslate(array('s'=>'Product customization'),$_smarty_tpl);?>
</p>
...
<?php echo smartyTranslate(array('s'=>'Out of stock','js'=>1),$_smarty_tpl);?>
