<?php /* Smarty version Smarty-3.1.19, created on 2016-11-02 14:44:12
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/override/controllers/admin/templates/products/informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8467422775819edac1adbe9-96999710%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f4bd3f249ae312119dd7f27bc0a0b8827ac01eb1' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/override/controllers/admin/templates/products/informations.tpl',
      1 => 1473092640,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8467422775819edac1adbe9-96999710',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5819edac363ce1_58470043',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5819edac363ce1_58470043')) {function content_5819edac363ce1_58470043($_smarty_tpl) {?>
...
";
		...
		/* Added by Olivier to hide description lengow when multishop*/
		var ProductMultishop = ProductMultishop;
		ProductMultishop.checkAllInformations = function () {
			...
			$.each(languages, function (k, v) {
				...
				ProductMultishop.checkField($('input[name=\'multishop_check[description_lengow][' + v.id_lang + ']\']').prop('checked'), 'description_lengow_' + v.id_lang, 'tinymce');
			});
		};
		/*End Added Olivier*/
...
">
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right"><?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('field'=>"universe",'type'=>"tinymce",'multilang'=>"true"), 0);?>
</span></div>
		<label class="control-label col-lg-2" for="universe_<?php echo $_smarty_tpl->tpl_vars['id_lang']->value;?>
">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'Appears in the body of the product page.'),$_smarty_tpl);?>
">
				<?php echo smartyTranslate(array('s'=>'Universe'),$_smarty_tpl);?>

			</span>
		</label>
		<div class="col-lg-9">
			<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/textarea_lang.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('languages'=>$_smarty_tpl->tpl_vars['languages']->value,'input_name'=>'universe','class'=>"autoload_rte",'input_value'=>$_smarty_tpl->tpl_vars['product']->value->universe), 0);?>

		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right"><?php echo $_smarty_tpl->getSubTemplate ("controllers/products/multishop/checkbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('field'=>"description_lengow",'type'=>"tinymce",'multilang'=>"true"), 0);?>
</span></div>
		<label class="control-label col-lg-2" for="description_lengow_<?php echo $_smarty_tpl->tpl_vars['id_lang']->value;?>
">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'Permit an export to lengow module'),$_smarty_tpl);?>
">
				<?php echo smartyTranslate(array('s'=>'Description Lengow:'),$_smarty_tpl);?>

			</span>
		</label>
		<div class="col-lg-9">
			<?php echo $_smarty_tpl->getSubTemplate ("controllers/products/textarea_lang.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('languages'=>$_smarty_tpl->tpl_vars['languages']->value,'input_name'=>'description_lengow','class'=>"autoload_rte",'input_value'=>$_smarty_tpl->tpl_vars['product']->value->description_lengow), 0);?>
