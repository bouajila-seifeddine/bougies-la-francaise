<?php /* Smarty version Smarty-3.1.19, created on 2016-11-02 17:21:45
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1429712047581a12991dbc43-23365741%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ddabd07754c255b82217c32f04be8778ac9f244' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/modules/blockcart/blockcart.tpl',
      1 => 1476974083,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1429712047581a12991dbc43-23365741',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_581a1299490579_26958169',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_581a1299490579_26958169')) {function content_581a1299490579_26958169($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/modifier.replace.php';
...
<div class="blockcart-top-box clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
...
" rel="nofollow">
			...
			<i class="ycon-panier"><span class="ajax_cart_quantity cart-icon"><?php if ($_smarty_tpl->tpl_vars['cart_qties']->value!=0) {?><?php echo $_smarty_tpl->tpl_vars['cart_qties']->value;?>
<?php }?></span></i>
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
							...
							<?php if ($_smarty_tpl->tpl_vars['show_tax']->value&&isset($_smarty_tpl->tpl_vars['tax_cost']->value)) {?>
								<div class="cart-prices-line cart_tax_cost_line">
						...
						<p class="cart-buttons">
							<a id="button_order_cart" class="btn-blf" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>
				...
				<div class="button-container">
					<span class="continue btn-blf-cart-back" title="<?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart'),$_smarty_tpl);?>
">
						<i class="ycon-left-open-big"></i>
						<span><?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					</span>
					<a class="btn-blf-cart medium"	href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Proceed to checkout','mod'=>'blockcart'),$_smarty_tpl);?>
" rel="nofollow">
						<span><?php echo smartyTranslate(array('s'=>'Proceed to checkout','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					</a>
				</div>
			</div>
