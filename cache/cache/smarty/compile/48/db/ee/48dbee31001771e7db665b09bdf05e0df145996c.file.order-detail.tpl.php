<?php /* Smarty version Smarty-3.1.19, created on 2016-10-21 12:05:56
         compiled from "/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21282059495809e8841e6a06-24974313%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '48dbee31001771e7db665b09bdf05e0df145996c' => 
    array (
      0 => '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/themes/bougie-la-francaise/order-detail.tpl',
      1 => 1475245094,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21282059495809e8841e6a06-24974313',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5809e8844bf214_09682970',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5809e8844bf214_09682970')) {function content_5809e8844bf214_09682970($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/bougies-la-francaise/domains/new.bougies-la-francaise.com/public_html/tools/smarty/plugins/modifier.replace.php';
...
" name="id_order"/>
		...
		<a href="#" onclick="$(this).closest('form').submit(); return false;" class="btn-blf reorder"><span><?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
 <i class="ycon-right-open-big"></i></span></a>
	</form>
	<?php }?>
	<p class="dark">
...
<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?>
	<div id="returnOrderMessage">
		...
		<p class="form-group">
			<button type="submit" name="submitReturnMerchandise" class="btn-blf-cart-back">
				<span><?php echo smartyTranslate(array('s'=>'Make an RMA slip'),$_smarty_tpl);?>
</span>
...
"/>
			<button type="submit" name="submitMessage" class="btn-blf-cart-next"><span><?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
</span></button>
		</div>
	</form>
<?php } else { ?>
