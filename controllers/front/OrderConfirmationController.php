...
class OrderConfirmationControllerCore extends FrontController
{
	...
	public function initContent()
	{
		...
		$custome_order_obj = new Order((int)($this->id_order));
		$currency = new Currency($custome_order_obj->id_currency);
		$products = $custome_order_obj->getProducts();
		...
		$this->context->smarty->assign(array(
			...
			'order' => $custome_order_obj,
			'currency' => $currency,
			'products' => $products,
			'order_total_paid' => $custome_order_obj->total_paid,			
		));
