...
<div data-role="content" id="content">
	...
	{/if}
	<p class="clear">
		<a href="{$link->getPageLink('authentication', true)}"><img src="{$img_dir}icon/my-account.gif" alt="{l s='Return to Login'}" class="icon" /></a><a href="{$link->getPageLink('authentication')|escape:'html'}" data-ajax="false">{l s='Back to Login'}</a>
	</p>
</div><!-- /content -->
