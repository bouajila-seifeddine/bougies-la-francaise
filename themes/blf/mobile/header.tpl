...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript">/* <![CDATA[ *//* ]]> */</script>
		...
		<div data-role="header" id="header" class="ui-body-c">
			<div class="ui-grid-a">
				<div class="ui-block-a">
					<a href="{$base_dir}" data-ajax="false"><img src="{$logo_url}" alt="{$shop_name|escape:'htmlall':'UTF-8'}" {if $logo_image_width}width="{$logo_image_width}"{/if} {if $logo_image_height}height="{$logo_image_height}" {/if} /></a>
				</div>
