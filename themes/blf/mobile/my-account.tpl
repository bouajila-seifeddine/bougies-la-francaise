...
<div data-role="content" id="content">
		...
		<ul data-role="listview" data-inset="true" id="list_myaccount">
			...
			<li>
				<a href="{$link->getPageLink('address', true)|escape:'html'}" data-ajax="false">
			...
			{/if}
			<li>
				<a href="{$link->getPageLink('history', true)|escape:'html'}" data-ajax="false">
			...
			{if $returnAllowed}
			<li>
				<a href="{$link->getPageLink('order-follow', true)|escape:'html'}" data-ajax="false">
			...
			{/if}
			<li>
				<a href="{$link->getPageLink('order-slip', true)|escape:'html'}" data-ajax="false">
					<img src="{$img_mobile_dir}icon/slip.png" alt="{l s='Credit slips'}" class="ui-li-icon ui-li-thumb" />
					{l s='My credit slips'}
				</a>
			</li>
			<li>
				<a href="{$link->getPageLink('addresses', true)|escape:'html'}" data-ajax="false">
					<img src="{$img_mobile_dir}icon/addrbook.png" alt="{l s='Addresses'}" class="ui-li-icon ui-li-thumb" />
					{l s='My addresses'}
				</a>
			</li>
			<li>
				<a href="{$link->getPageLink('identity', true)|escape:'html'}" data-ajax="false">
			...
			{if $voucherAllowed}
			<li>
				<a href="{$link->getPageLink('discount', true)|escape:'html'}" data-ajax="false">
			...
			<li data-icon="delete" data-theme="a">
				<a href="{$link->getPageLink('index', true)}?mylogout" data-ajax="false">
					{l s='Sign out'}
				</a>
			</li>
		...
		<a href="{$base_dir}" class="lnk_my-account_home" data-ajax="false">
