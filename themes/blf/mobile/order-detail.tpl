...
<div class="ui-grid-a">
	<div class="ui-block-a">
		<a data-role="button" data-icon="arrow-l" data-theme="a" data-rel="back" href="#" data-ajax="false">{l s='Back'}</a>
	</div>
	<div class="ui-block-b">
		...
		{/if}
		<a data-icon="refresh" data-role="button" data-theme="e" href="{$link->getPageLink({$type_order}, true, NULL, "submitReorder&id_order={$order->id|intval}")|escape:'html'}" data-ajax="false">
		{l s='Reorder'}
		</a>
	</div>
</div><!-- .ui-grid-a -->
