		...
		{if $ordersSlip && count($ordersSlip)}
			...
			{foreach from=$ordersSlip item=slip name=myLoop}
				<li>
					...
					<a rel="external" data-iconshadow="false" href="{$link->getPageLink('pdf-order-slip', true, NULL, "id_order_slip={$slip.id_order_slip|intval}")|escape:'html'}" data-ajax="false">
						{l s='PDF'}
					</a>
				</li>
			{/foreach}
