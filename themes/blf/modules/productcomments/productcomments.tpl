...
<div id="idTab5">
	...
	{if $comments}
	    <h3>{l s='Opinions' mod='productcomments'}</h3>
    		...
    		<div class="new_comment_form_content">
    			...
    			{if $criterions|@count > 0}
    				...
    				{foreach from=$criterions item='criterion'}
    					<li>
    						<label>{l s='Quality' mod='productcomments'} <sup class="required">*</sup></label>
                ...
                <div class="fields_content">
    				...
    				<label for="content" class="last">{l s='Comment' mod='productcomments'} <sup class="required">*</sup></label>
