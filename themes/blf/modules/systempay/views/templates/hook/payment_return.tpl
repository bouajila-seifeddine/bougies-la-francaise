...
{else}
	<div id="payment-result">
        ...
        <p id="follow">
            {l s='Follow ours news on' mod='systempay'}<br />
            <a class="facebook" target="_blank" href="https://www.facebook.com/bougies.la.francaise">Facebook</a>
            <a class="pinterest" target="_blank" href="http://www.pinterest.com/bougiesLF/">Pinterest</a>
        </p>
...
{literal}
	...
	<script type="text/javascript">
		/* <![CDATA[ */
		var google_conversion_id = 960781653;
		var google_conversion_language = "en";
		var google_conversion_format = "3";
		var google_conversion_color = "ffffff";
		var google_conversion_label = "5xNKCKqEj1cQ1bqRygM";
	...
	<noscript>
		<div style="display:inline;">
			<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/960781653/?label=5xNKCKqEj1cQ1bqRygM&amp;guid=ON&amp;script=0"/>
		</div>
	</noscript>
{/literal}
