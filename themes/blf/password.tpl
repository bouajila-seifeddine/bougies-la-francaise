...
{capture name=path}<a href="{$link->getPageLink('authentication', true)|escape:'html'}" rel="nofollow">{l s='Authentication'}</a><span class="navigation-pipe">{$navigationPipe}</span>{l s='Forgot your password'}{/capture}
...
<p class="clear">
	<a href="{$link->getPageLink('authentication')|escape:'html'}" rel="nofollow">{l s='Back to Login'}</a>
</p>
