			...
			{else}
				...
				<form action="{$request_uri}" method="post" class="contact-form-box" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="submit">
							<button type="submit" name="submitMessage" id="submitMessage" class="btn-blf white">{l s='Send'}</button>
						</div>
					</fieldset>
				</form>
			{/if}
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 col-sm-5">
				<h3 class="contact-title">{l s='Customer service'}</h3>
				<p>
					<strong>{l s='Bougies la Française'}</strong>
					<br />
					<br />{l s='Rue du président Auguste Durand'}
					<br />{l s='BP 70002'}
					<br />{l s='85610 CUGAND- France'}
					<br />
					<br />{l s='Customer service at your disposal to '}
					<br /><a href="tel:+33251421972" class="tel">{l s='+33 2 51 42 19 72'}</a>
					<br />
					<br />{l s='Monday-Friday 19h-12h30 et 14h-16h'}
					<br />
					<br />
					<br /><a href="{$link->getCMSLink(12)|escape:'html':'UTF-8'}">{l s='VIEW FAQ'}</a>
				</p>
			</div>
			<div class="col-md-8 col-sm-7">
				<a href="https://goo.gl/maps/pgGASjjZXj52" target="_blank" class="blf-ggl-map"><img src="/themes/bougie-la-francaise/image/design/blf-map.jpg" alt="{l s='Access map'}" /></a>
			</div>
		</div>
	</div>
</div>
