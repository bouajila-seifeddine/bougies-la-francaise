...
function searchLocationsNear(center)
{
	...
	downloadUrl(searchUrl, function(data) {
		...
		for (var i = 0; i < markerNodes.length; i++)
		{
			...
			stores_list += '<div class="col-sm-3 col-xs-12"><div class="store-box"><h4>'+name+'</h4><div class="address">'+address+(phone !== '' ? ''+translation_4+' '+phone : '')+'</div><div class="distance">'+distance+' '+distance_unit+'</div></div></div>';
			$('#stores-table').show();
		}
		$('#stores-table').html(stores_list);
