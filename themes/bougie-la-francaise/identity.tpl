...
<div class="container">
	<div class="row">
		<ul class="footer_links clearfix">
			<li>
				<a class="btn-blf back" href="{$link->getPageLink('my-account', true)}">
					<span>
			...
			<li>
				<a class="btn-blf back" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}">
					<span>
						<i class="ycon-left-open-big"></i>{l s='Home'}
					</span>
				</a>
			</li>
		</ul>
