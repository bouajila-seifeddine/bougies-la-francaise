...
<div id="mywishlist">
	...
	<ul class="footer_links clearfix">
		<li><a class="btn-blf back" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}"><span><i class="ycon-left-open-big"></i> {l s='Back to your account' mod='blockwishlist'}</span></a></li>
		<li><a class="btn-blf back" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}"><span><i class="ycon-left-open-big"></i> {l s='Home' mod='blockwishlist'}</span></a></li>
	</ul>
</div>
