...
{else}
	...
	<section class="footer-block-cms col-sm-3" id="block_customer_services">
		<h4>{l s='Customer services' mod='blockcms'} <i class="ycon-down-open-big"></i></h4>
		<ul class="toggle-footer">
			...
			{/if}
			<li><a href="{$link->getCMSLink(1)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Shipping' mod='blockcms'}">{l s='Shipping' mod='blockcms'}</a></li>
			<li><a href="{$link->getCMSLink(11)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Satisfied or refunded' mod='blockcms'}">{l s='Satisfied or refunded' mod='blockcms'}</a></li>
			<li><a href="{$link->getCMSLink(5)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Secure payment' mod='blockcms'}">{l s='Secure payment' mod='blockcms'}</a></li>
			<li><a href="{$link->getCMSLink(12)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='FAQ' mod='blockcms'}">{l s='FAQ' mod='blockcms'}</a></li>
			<li><a href="{$link->getCMSLink(3)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Terms of sales' mod='blockcms'}">{l s='Terms of sales' mod='blockcms'}</a></li>
		</ul>
	</section>

	<section class="footer-block-cms col-sm-3" id="block_categories">
		<h4>{l s='Categories' mod='blockcms'} <i class="ycon-down-open-big"></i></h4>
		<ul class="toggle-footer">
