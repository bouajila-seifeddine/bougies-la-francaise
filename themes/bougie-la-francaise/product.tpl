	...
	<div class="primary_block row">
				...
				<div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if}">
					...
					{if isset($images) && count($images) > 2}
						<div class="view_scroll_spacer">						
							<a id="view_scroll_right" class="view_scroll_spacer" title="{l s='Other views'}" href="javascript:{ldelim}{rdelim}">
								{l s='Next'}
							</a>
						</div>
					{/if}
		...
		<div class="product-infos-side col-md-6 col-sm-6 col-xs-12">
			...
			<div class="pb-center-column">
				...
				<p class="product-collection">{if isset($features.feature7)}{$features.feature7.value}{/if}</p>
				...
				{if $product->description_short || $packItems|@count > 0}
					<div id="short_description_block">
						...
						{if $product->description}
							<a href="#full-description-product" class="more-detail">{l s='More details'} &gt;</a>
							{if !empty($product->universe)}
							<br /><a href="#full-universe-product" class="more-detail">{l s='Universe information'} &gt;</a>
							{/if}
							{*<!--
				...
				<div class="more-product-infos">
					<div class="infos-delivery-shipping">
						<p><span>{l s='Delivery delay'} : </span>{l s='2 or 3 days'}</p>
						<p><span>{l s='Shipping'} : </span>{l s='Free shipping with 50€ minimum purchase'}</p>
						<p><span>{l s='Product code'} : </span>{$product->id}</p>
						{*<!--
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
			...
			<section class="page-product-box">
				<p class="page-product-heading">{l s='Volume discounts'}</p>
...
<div class="full-container">
					...
					<div class="row">	
						{if isset($product) && $product->description}
							...
							<section class="page-product-box col-sm-6 col-xs-12">
								<p class="page-product-heading">{l s='More info'}</p>
								<!-- full description -->
						...
						{if isset($features) && $features}
							<!-- Data sheet -->
							<section class="page-product-box col-sm-6 col-xs-12">
								<p class="page-product-heading">{l s='Data sheet'}</p>
	...
	{if isset($product) && !empty($product->universe)}
				...
				<div class="center_column col-xs-12">
					<div class="row">	
						...
						<section class="page-product-box col-xs-12">
							<p class="page-product-heading">{l s='Universe'}</p>
							<!-- full universe -->
							<div class="rte">{$product->universe}</div>
							<div class="universe-link"><a href="{$link->getCMSLink(75)}">{l s="See all universes"}</a></div>
						</section>
						<!--end  More info -->
					</div>
				</div>
...
<div class="row">
	<div class="center_column col-xs-12 col-sm-12">
		...
		<section id="blockpack">
			<p class="page-product-heading">{l s='Pack content'}</p>
		...
		{if isset($accessories) && $accessories}
			<!--Accessories -->
			<section class="page-product-box">
				<p class="secondary-title"><span>{l s='Accessories'}</span></p>
									...
									<li class="item product-box ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
										...
										<div class="s_title_block">
											<a href="{$accessoryLink|escape:'html':'UTF-8'}">
												<div class="accessory-collection">{if isset($collection)}<span>{$collection|escape:'html':'UTF-8'}</span>{/if}</div>
												<p itemprop="name" class="product-name">{$accessory.name|escape:'html':'UTF-8'}</p>
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<!--Download -->
			<section class="page-product-box">
				<p class="page-product-heading">{l s='Download'}</p>
			...
			<!--Customization -->
			<section class="page-product-box">
				<p class="page-product-heading">{l s='Product customization'}</p>
...
{addJsDefL name=doesntExistNoMore}{l s='Out of stock' js=1}{/addJsDefL}
