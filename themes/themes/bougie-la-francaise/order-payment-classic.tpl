...
<div class="paiement_block">
    ...
    {if $HOOK_PAYMENT}
		...
		<h2 class="page-heading">{l s='Please choose your payment method'}</h2>
    ...
    <p class="cart_navigation clearfix">
        <a href="{$link->getPageLink('order', true, NULL, "step=2")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="btn-blf-cart-back">
