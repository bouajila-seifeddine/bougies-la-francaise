...
<div class="blockcart-top-box clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<i class="ycon-panier"><span class="ajax_cart_quantity cart-icon">{if $cart_qties != 0}{$cart_qties}{/if}</span></i>
			{*<!--
				...
				<div class="block_content">
					...
					<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
						...
						<p class="cart-buttons">
							<a id="button_order_cart" class="btn-blf" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
								<span>
		...
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="button-container">
					<span class="continue btn-blf-cart-back" title="{l s='Continue shopping' mod='blockcart'}">
						<i class="ycon-left-open-big"></i>
						<span>{l s='Continue shopping' mod='blockcart'}</span>
					</span>
					<a class="btn-blf-cart medium"	href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
