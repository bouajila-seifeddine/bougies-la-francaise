				...
				{else}
                    ...
                    <div class="container">
						<div class="row">
							...
							<div class="col-sm-6 cat-scene-bg" {if $category->id_image} style="background:url({$link->getCatImageLink($category->link_rewrite, $category->id_image)|escape:'html':'UTF-8'}) right center no-repeat; background-size:cover; {*min-height:{$categorySize.height}px;*}"{/if}>
			...
			<div class="col-md-9 col-sm-8">
				<div class="content_sortPagiBar clearfix">
					<div class="sortPagiBar clearfix">
						{include file="./product-count.tpl"}
