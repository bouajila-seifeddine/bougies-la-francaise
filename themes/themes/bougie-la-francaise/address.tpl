			...
			<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std" id="add_address">
				...
				{foreach from=$ordered_adr_fields item=field_name}
					...
					{if $field_name eq 'phone_mobile'}
						...
						<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group phone-mobile">
...
<div class="container">
	<div class="row">
		<ul class="footer_links clearfix">
			<li>
				<a class="btn-blf back" href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}">
					<span><i class="ycon-left-open-big"></i> {l s='Back to your addresses'}</span>
				</a>
			</li>
		</ul>
	</div>
