...
{capture name=path}
	{if !isset($email_create)}{l s='Authentication'}{else}
		<a href="{$link->getPageLink('authentication', true)|escape:'html'}" rel="nofollow">{l s='Authentication'}</a>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="login_form" class="std">
		<fieldset>
			...
			<div class="form_content clearfix">
				...
				<p class="lost_password"><a href="{$link->getPageLink('password')|escape:'html'}" rel="nofollow">{l s='Forgot your password?'}</a></p>
				<p class="submit">
