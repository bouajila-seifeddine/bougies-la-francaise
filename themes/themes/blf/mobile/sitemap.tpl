		...
		{for $i=0 to 4}
			{if isset($categoriesTree.children.$i)}
				...
				<li data-icon="arrow-d">
					<a href="{$categoriesTree.children.$i.link|escape:'htmlall':'UTF-8'}">
...
<ul data-role="listview" data-inset="true" id="category">
	...
	<li>{l s='Our offers'}
		<ul data-role="listview" data-inset="true">
			...
			<li><a href="{$link->getPageLink('best-sales', true)|escape:'html'}">{l s='Best sellers'}</a></li>
			{/if}
	...
	<li>{l s='Pages'}
		<ul data-role="listview" data-inset="true">
			...
			{if $display_store}<li><a href="{$link->getPageLink('stores')|escape:'html'}">{l s='Our stores'}</a></li>{/if}
		</ul>
	</li>
</ul>
