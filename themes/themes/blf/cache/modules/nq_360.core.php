...
if (!defined('_PS_VERSION_'))
  exit;
//test here
include('/raid/www/blf/modules/nq_360' . "/config/config.php");
class NQ_360Module extends Module
{
    ...
    public function hookProductActions($params)
    {
        ...
        list($width, $height) = getimagesize('/raid/www/blf/modules/nq_360' . "/img_360/" . $t_img[0]);
        ...
        if (is_array($t_img) && count($t_img) > 1)
         {
                ...
                list($width, $height) = getimagesize('/raid/www/blf/modules/nq_360' . "/img_360/" . $t_img[0]);
                list($Hdwidth, $Hdheight) = getimagesize('/raid/www/blf/modules/nq_360' . "/img_360/" . "hd-" . $t_img[1]);
