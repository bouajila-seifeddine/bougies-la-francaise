...
function updateCartSummary(json)
{
    ...
    /* Added by Olivier to show/hide message for free delivery text in order status */
    if(json.total_products_wt < 45) {
        $("#delivery_rest strong span").html(formatCurrency((45-json.total_products_wt), currencyFormat, currencySign, currencyBlank));
        $("#delivery_rest").fadeIn();
    }
    else {
        $("#delivery_rest").fadeOut();
    }
	...
	{
		//Added by Olivier : Solivan want all the time display : Free Shipping
