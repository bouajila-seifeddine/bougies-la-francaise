...
{if isset($p) AND $p}
    ...
    {if $start!=$end}
        ...
        {if $p != 1}
            ...
            <li id="pagination_previous"><a {$no_follow_text} rel="{$p_previous}" class="pagination_page_number" href="{$link->goPage($requestPage, $p_previous)}"><i class="icon-chevron-left"></i></a></li>
        {else}
        ...
        {if $pages_nb > 1 AND $p != $pages_nb}
            ...
            <li id="pagination_next"><a class="pagination_page_number" {$no_follow_text} rel="{$p_next}" href="{$link->goPage($requestPage, $p_next)}"><i class="icon-chevron-right"></i></a></li>
        {else}
