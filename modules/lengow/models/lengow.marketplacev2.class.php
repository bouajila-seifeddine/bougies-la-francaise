 ...
 * @copyright 2015 Lengow SAS
 */
class LengowMarketplaceV2Abstract {
	...
	*/
	...
	{
		$array_fields = array();
		foreach (LengowMarketplaceV2::$MARKETPLACES_FBA as $key => $marketplace_name)
	...
	*/
	protected function makeRequest($url)
	{
		...
		if ($result === false)
		{
			throw new LengowWsdlExceptionV2(
				array(
 ...
 */
class LengowWsdlExceptionV2Abstract extends Exception {
