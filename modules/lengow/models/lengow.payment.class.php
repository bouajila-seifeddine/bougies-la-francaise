...
class LengowPaymentModuleAbstract extends PaymentModule
{
	 ...
	 */
	public function makeOrder($id_cart, $id_order_state, $payment_method, $message, $lengow_products, $lengow_shipping_costs, $processing_fees = null)
	{
		...
		foreach ($package_list as $id_address => $packageByAddress)
			...
			foreach ($packageByAddress as $id_package => $package)
			{
				...
				$order->total_wrapping_tax_excl = (float)Tools::ps_round($tax_calculator->removeTaxes((float)$processing_fees), 2);
				...
				if (!$result)
				{
					...
					throw new PrestaShopException('unable to save order: '.Db::getInstance()->getMsgError());
				}
