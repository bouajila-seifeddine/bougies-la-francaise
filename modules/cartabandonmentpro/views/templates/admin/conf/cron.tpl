...
<div class="row">
	...
	<div style="margin-left: 20px;margin-bottom: 10px;">
		{l s='First reminder:' mod='cartabandonmentpro'} 0	*	*	*	* php -f {$dirname}/send.php {$id_shop} {$token_send} 1<br>
		{l s='Second reminder:' mod='cartabandonmentpro'} 0	*	*	*	* php -f {$dirname}/send.php {$id_shop} {$token_send} 2<br>
		{l s='Third reminder:' mod='cartabandonmentpro'} 0	*	*	*	* php -f {$dirname}/send.php {$id_shop} {$token_send} 3<br>
	</div>
