  ...
  Line.prototype = {
    ...
    getHTML: function(sfrom, sto, includePre, endAt) {
        ...
        function span(text, style) {
          if (!text) return;
          /*Edit by presta-Module*/

          var regNoSpan1=new RegExp("{%", "g");
          var regNoSpan2=new RegExp("%}", "g");
          if (text.match(regNoSpan1)) {noSpan = true;html.push(text);return}
          if (text.match(regNoSpan2)) {noSpan = false;html.push(text);return;}
          if(noSpan) {html.push(text);return;}
        ...
        var strReturn = html.join("");
        var regReplace1=new RegExp("%}", "g");
        strReturn = strReturn.replace(regReplace1,'</span>');
        var regReplace2=new RegExp("{%", "g");
        strReturn = strReturn.replace(regReplace2,'<');
        /*var regReplace3=new RegExp("\\+}", "g");
        strReturn = strReturn.replace(regReplace3,'>');*/
