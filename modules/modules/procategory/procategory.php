		...
		return array(
			...
			public function hookDisplayHome($params)
				{			
				  ...
				  /*
					Modification de la clause where pour afficher les sous catégorie de niveau 4
					old : WHERE level_depth > 1 And level_depth < 3
				  */
				  ...
				  foreach ($result as $key => $value) 
                    ...
                    $this->context->smarty->assign(array(
						  'category' => $category,
						  'categories' => $res, Category::getRootCategories(intval($params['cookie']->id_lang), true)));
