<?php
	$openinviter_settings=array(
		"username"=>Configuration::get('RSPONSORSHIP_OPEN_INVITER_LOGIN'),
		"private_key"=>Configuration::get('RSPONSORSHIP_OPEN_INVITER_KEY'),
		"cookie_path"=> realpath(dirname(__FILE__).'/tmp'),
		"message_body"=>"You are invited to http://www.prestaplugins.com", // http://www.prestaplugins.com is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to http://www.prestaplugins.com", // http://www.prestaplugins.com is the website on your account. If wrong, please update your account at OpenInviter.com
