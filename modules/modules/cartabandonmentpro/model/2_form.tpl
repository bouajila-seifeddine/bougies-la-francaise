	...
	<table width="600" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td width="166" valign="middle">
				<a href="{$url}" target="_blank"><img style="text-decoration: none; display: block; color:#476688; font-size:30px;display:block;vertical-align:top;" 
				src="http://{$logo}" border="0"></a>
			</td>
		</tr>
		</tbody>
	</table>
