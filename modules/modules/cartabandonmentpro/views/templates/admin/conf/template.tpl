	...
	<div class="form-group">
		...
		<br>
        %FIRSTNAME% - {l s='will be replace by the client first name' mod='cartabandonmentpro'}<br>
        %LASTNAME% - {l s='will be replace by the client last name' mod='cartabandonmentpro'}<br>
		%GENDER% - {l s='will be replace by the client gender' mod='cartabandonmentpro'}<br>
        %CART_PRODUCTS% - {l s='will be replace by the custumer\'s cart content' mod='cartabandonmentpro'}<br>
        {l s='i.e. Mr' mod='cartabandonmentpro'} %FIRSTNAME%  %LASTNAME%, {l s='your products are waiting for you !' mod='cartabandonmentpro'}<br><br>
		{l s='In order to insert a link pointing to your store : click %SHOP_LINK_OPEN%here%SHOP_LINK_CLOSE% to access to our shop.' mod='cartabandonmentpro'}<br>
		{l s='In order to insert an unsubscribe link : click %UNUBSCRIBE_OPEN%here%UNUBSCRIBE_CLOSE% to not receive future emails.' mod='cartabandonmentpro'}<br>
		...
		<br>
		%DISCOUNT_VALUE% - {l s='Amount of discount. E.g. 20% or 50 €' mod='cartabandonmentpro'}
		<br>
		%DISCOUNT_VALID_DAY% %DISCOUNT_VALID_MONTH% %DISCOUNT_VALID_YEAR% - {l s='Discount expiry date. E.g. 4/11/2014' mod='cartabandonmentpro'}
		<br>
		%DISCOUNT_CODE% - {l s='Discount code. E.g. CAVa70c6' mod='cartabandonmentpro'}
		<br><br>
		...
		<div class="form-group">
			...
			<div class="input-group col-xs-8">
			  <input type="text" name="discount_val_text" id="discount_val_text" value="{$discount_val_text}" class="form-control col-xs-7">
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label" for="discounts_value">
			...
			<div class="input-group col-xs-8">
			  <input type="text" name="discount_shipping_text" id="discount_shipping_text" value="{$discount_shipping_text}" class="form-control col-xs-7">
			</div>
		</div>
		{l s='When you finish writing your text and you save it, use this tag: ' mod='cartabandonmentpro'}
		%DISCOUNT_TXT%
		{l s='in order to show your text on your email. You should copy-paste this tag in the body of your template. Your shipping text or discount text will appear instead of the tag.' mod='cartabandonmentpro'}
		<br><br>
	...
	<div>
		<p>
			<a onClick="exempleTemplate(1, '{$token}', '{$iso_lang}')">{l s='Template example' mod='cartabandonmentpro'}</a>
		</p>
	</div>
	<!-- Template 1 -->
	...
	<div class="row" style="margin-top: 5px;">
		<div class="col-md-1 col-md-offset-4">
			<button class="btn btn-teal btn-block btn-primary col-md-1" type="submit">
