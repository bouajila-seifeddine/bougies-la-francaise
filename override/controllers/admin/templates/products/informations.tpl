...
<table cellpadding="5" cellspacing="0" border="0" style="width: 100%;"><tr><td><div class="separation"></div></td></tr></table>
		<table cellspacing="0" cellpadding="5" border="0">
			...
			<tr>
				<td class="col-left">
					{include file="controllers/products/multishop/checkbox.tpl" field="description_lengow" type="tinymce" multilang="true"}
					<label>{l s='Description Lengow:'}<br /></label>
					<p class="product_description">({l s='Permit an export to lengow module'})</p>
				</td>
				<td style="padding-bottom:5px;">
					{include file="controllers/products/textarea_lang.tpl" languages=$languages
					input_name='description_lengow'
