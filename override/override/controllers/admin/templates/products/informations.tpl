...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="universe" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="universe_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='Appears in the body of the product page.'}">
				{l s='Universe'}
			</span>
		...
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='universe'
				class="autoload_rte"
				input_value=$product->universe}
		</div>
	</div>
	<div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="description_lengow" type="tinymce" multilang="true"}</span></div>
		<label class="control-label col-lg-2" for="description_lengow_{$id_lang}">
			<span class="label-tooltip" data-toggle="tooltip"
				title="{l s='Permit an export to lengow module'}">
				{l s='Description Lengow:'}
			</span>
		</label>
		<div class="col-lg-9">
			{include
				file="controllers/products/textarea_lang.tpl"
				languages=$languages input_name='description_lengow'
				class="autoload_rte"
				input_value=$product->description_lengow}
		</div>
	</div>
	{if $images}
	<div class="form-group">
